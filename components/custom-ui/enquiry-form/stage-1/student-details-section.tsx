...
// Enums and Constants
import { AdmissionMode, AdmissionReference, Category, Course, CourseNameMapper } from '@/static/enum';
...
const StudentDetailsSection : React.FC<StudentDetailsFormPropInterface> = ({form , commonFormItemClass, commonFieldClass}) => {
  return (
